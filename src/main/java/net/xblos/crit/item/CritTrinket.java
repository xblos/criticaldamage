...
public abstract class CritTrinket extends TrinketItem {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        if (chance > 0) tooltip.add(new TranslatableText("tooltip.crit.chance", chance).formatted(DARK_GRAY));
        if (damage > 0) tooltip.add(new TranslatableText("tooltip.crit.damage", damage).formatted(DARK_GRAY));
    }
}
